...
-- This file is the canonical merged database setup.
-- It supersedes the old `config/init.sql` file.
...
DROP TABLE IF EXISTS `teacher_registration_requests`;
...
(1, 'Administrator', 'admin', NULL, '$2y$10$2ivTkVJFBz5Xldn66iYFeeXTZ7shjBGKDyYD8AIydsfxmAmj71a02', 'admin', NULL, '2026-02-18 08:27:04', '2026-02-16 09:09:24'),
(2, 'Teacher', 'teacher', NULL, '$2y$10$YU4J1Hovqq.G74uniwBig.HBwUpPJ/oPnpqb49pvP2d1JooqAda2.', 'teacher', NULL, NULL, '2026-02-16 09:09:24'),
...
--
-- Table structure for table `teacher_registration_requests`
--
...
--
-- Indexes for table `teacher_registration_requests`
--
ALTER TABLE `teacher_registration_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_teacher_registration_status` (`status`),
  ADD KEY `idx_teacher_registration_username` (`username`),
  ADD KEY `idx_teacher_registration_email` (`email`);
...
--
-- AUTO_INCREMENT for table `teacher_registration_requests`
--
ALTER TABLE `teacher_registration_requests`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
ALTER TABLE `teacher_profiles`
  ADD CONSTRAINT `fk_teacher_profiles_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
SET FOREIGN_KEY_CHECKS = 1;
COMMIT;
